...
<head>
  ...
  <style>
    ...
    * {
    ...
    .visi-box {
      background: linear-gradient(135deg, rgba(0, 102, 204, 0.08), rgba(135, 206, 235, 0.1));
      padding: 40px;
      border-radius: 20px;
    ...
    .misi-container {
      background: linear-gradient(135deg, rgba(0, 102, 204, 0.06), rgba(135, 206, 235, 0.08));
      padding: 40px;
      border-radius: 20px;
      border: 2px solid rgba(0, 102, 204, 0.2);
      margin: 40px 0;
  ...
  <section class="hero-section">
    <div class="hero-content">
      ...
      <div class="breadcrumb">
        <a href="../index.php">Beranda</a> / <a href="#">Tentang</a> / <span>Visi & Misi</span>
      </div>
    </div>
  </section>
