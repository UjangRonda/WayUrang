    ...
    <style>
        ...
        * {
        ...
        .hero-section {
            height: 100vh;
            background:
                linear-gradient(rgba(126, 87, 194, 0.6), rgba(79, 195, 247, 0.4)),
                url(../image/Aurora/Aurora\ \(4\).JPG) center/cover;
            display: flex;
            align-items: center;
        ...
        .about-content h2 {
            font-size: 3em;
            background: linear-gradient(135deg, #7E57C2, #4FC3F7, #FFD54F);
        ...
        .about-image {
            background: url('../image/Aurora/Aurora\ \(3\).JPG');
        ...
        /* ================= GALLERY SECTION ================= */
        .gallery-section {
            background: linear-gradient(135deg, #E1C4E9 0%, #FFFFFF 50%, #E1F5FE 100%);
            padding: 120px 0;
        }
        ...
        .feature-item:hover {
            ...
            box-shadow: 0 25px 50px rgba(126, 87, 194, 0.2);
            border-color: #7E57C2;
        }
        ...
        /* ================= INFO SECTION ================= */
        .info-section {
            background: linear-gradient(135deg, #7E57C2 0%, #4FC3F7 25%, #FFD54F 75%, #B3E5FC 100%);
            padding: 100px 0;
            color: white;
            text-align: center;
        }
        ...
        .contact-item {
            background: linear-gradient(135deg, #E1C4E9, #FFFFFF);
            padding: 40px 30px;
            border-radius: 15px;
        ...
        .back-button:hover {
            background: linear-gradient(135deg, #6a4db0, #29b6f6, #ffcc02);
            transform: scale(1.05);
        ...
        .footer {
            font-family: "Montserrat", sans-serif;
            background: linear-gradient(135deg, #7E57C2 0%, #4FC3F7 25%, #FFD54F 50%, #B3E5FC 100%);
            color: white;
            padding: 50px 0 0 0;
            margin-top: 50px;
            position: relative;
        ...
        .map-placeholder:hover {
            ...
            box-shadow: 0 12px 40px rgba(126, 87, 194, 0.2);
        }
...
<body>
    ...
    <section class="about-section">
        <div class="about-container">
            <div class="about-content">
                <h2>Tentang Pantai Aurora</h2>
                <p>Pantai Aurora adalah destinasi wisata bahari yang menawan di Aurora, Lampung Selatan—hanya sekitar 10 menit dari pusat kota. Pantai ini terkenal karena hamparan pasir putih halus, ombak lembut, dan panorama Gunung Rajabasa serta Pulau Krakatau di cakrawala.</p>
                <p>Posisinya yang langsung menghadap barat membuat Pantai Aurora menjadi tempat favorit untuk berburu sunset spektakuler. Spot-spot seperti gazebo kayu, bean bags, lampion, hingga kapal karam di tepi pantai menambah sentuhan estetika khas Instagrammable.</p>
            </div>
    ...
    <section class="info-section">
        <div class="info-container">
            <h2 class="info-title">Mengapa Memilih Pantai Aurora?</h2>
            <p class="info-description">
                Pantai Aurora bukan hanya sekedar destinasi wisata, tetapi sebuah pengalaman yang akan mengisi hati Anda dengan kedamaian dan kebahagiaan. Dengan keindahan alam yang masih asri dan fasilitas yang lengkap, pantai ini menjadi pilihan terbaik untuk melepas penat dari rutinitas sehari-hari.
            </p>
            ...
            <div class="contact-info">
                ...
                <div class="contact-item">
                    ...
                    <div class="social-icons-grid">
                        <a href="https://www.instagram.com/pantaiaurora/" target="_blank" class="icon-box ig" aria-label="Instagram">
                            <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/instagram.svg" alt="Instagram">
                        </a>
                        <a href="https://www.tiktok.com/@pantaiaurora" target="_blank" class="icon-box tiktok" aria-label="TikTok">
                            <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/tiktok.svg" alt="TikTok">
                        </a>
                        <a href="https://api.whatsapp.com/send?phone=085768675339" target="_blank" class="icon-box wa" aria-label="WhatsApp">
            ...
            <div class="ticket-info">
                ...
                <div class="ticket-grid">
                    <div class="ticket-card weekday">
                        ...
                        <ul>
                            <li>👨‍🦱🧒 Tiket Masuk (Include Biaya Parkir) : Rp 10.000 / orang</li>
                            <li>🗓️ Cottage Mulai dari Rp 300.000</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <footer class="footer">
            <div class="footer-container">
                <div class="footer-column">
                    ...
                    <div class="address">
                        <p>Jl. Samudra Pasai No.33, Way Urang, Kec. Aurora, Kota Lampung Selatan, Lampung<br>
                            Kode Pos 35716</p>
                    </div>
                </div>
                <div class="footer-column">
