...
.hero-section {
    height: 100vh;
    background: linear-gradient(rgba(255, 107, 61, 0.4), rgba(255, 166, 61, 0.4)),
  ...
  <body>
      ...
      <section class="hero-section">
          <div class="hero-content">
              ...
              <h1 class="hero-title"> Pantai Benteng </h1>
              <p class="hero-description">
                  Pantai Benteng merupakan destinasi wisata pesisir di Lampung Selatan yang dikenal dengan pintu gerbang masuk berbentuk menyerupai benteng serta suasana pantainya yang tenang dan cocok untuk bersantai.
              </p>
          </div>
      ...
      <section class="about-section">
          <div class="about-container">
              <div class="about-content">
                  <h2>Tentang Pantai Benteng</h2>
                  <p>Pantai Benteng merupakan objek wisata pesisir di Way Urang, Kalianda, Lampung Selatan yang dikenal dengan gerbang masuk menyerupai benteng. Ikon unik ini membuatnya mudah dikenali sekaligus menjadi spot foto favorit wisatawan.</p>
                  <p>Pantai ini menawarkan hamparan pasir berpadu batu karang serta pemandangan laut Selat Sunda dengan latar Gunung Rajabasa. Fasilitas seperti gazebo, tempat duduk, dan kios jajanan turut melengkapi kenyamanan pengunjung.</p>
                  <p>Cocok untuk bersantai, bermain air, atau menikmati matahari terbenam, Pantai Benteng menjadi pilihan rekreasi ringan warga lokal maupun wisatawan karena aksesnya mudah dari pusat Kota Kalianda.</p>
              </div>
